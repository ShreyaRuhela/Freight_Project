...
# Import your custom inference functions
...
if selected_model == "Freight Cost Prediction":
    ...
    **Objective:**
    ...
    if submit_freight:
        ...
        # Calling your inference function from predict_freight.py
...
# ---------------------------------------------------------
# ---------------------------------------------------------
# Module 2: Invoice Manual Approval Prediction
# ---------------------------------------------------------
else:
    ...
    **Objective:**
    ...
    with st.form("invoice_flag_form"):
        # Creating a 3-column layout as seen in your screenshot
        ...
        # Pink brain emoji button as per screenshot
        submit_flag = st.form_submit_button("🧠 Evaluate Invoice Risk")

    if submit_flag:
        # Preparing the data dictionary for the inference function
        input_data = {
        ...
        # Calling the classification inference function
        flag_prediction = predict_invoice_flag(input_data)['Predicted_Flag']
        
        # Converting the numerical prediction (0 or 1) to a boolean
